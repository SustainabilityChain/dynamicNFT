...
contract Token is ERC20 {
    constructor() ERC20("GLS Token", "GLS") {
        _mint(msg.sender, 1_000_000 * 10 ** decimals());
    }
}

contract GLSdNFT is ERC721 {
    address public tokenAddress;
    uint public tokenId;
    mapping(uint => bool) public isAlien;

    constructor() ERC721("Green List Standard Dynamic NFT", "GLSdNFT") {
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        string memory json1 = '{"name": "GLSdNFT", "description": "A dynamic NFT for IUCN", "image": "https://cloudflare-ipfs.com/ipfs/';
        string memory json2;
